...
bool DrawScatterPlot(RGBABitmapImageReference *canvasReference, double width, double height, std::vector<double> *xs, std::vector<double> *ys, StringReference *errorMessage, RGBA *color, bool lI, std::vector<wchar_t> *title);
